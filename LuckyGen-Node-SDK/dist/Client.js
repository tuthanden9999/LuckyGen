...
var Client = /** @class */ (function () {
    function Client(baseURL, token) {
        if (!token)
            throw new Error('Missing token in the constructor!');
    ...
    /**
         ...
         * @return {number} Player turn left
         */
    Client.prototype.addTurn = function (gameID, playerID, turns) {
        if (turns === void 0) { turns = 1; }
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.httpClient.post("games/" + gameID + "/add-turn", {
                            player_id: playerID,
                            turns: 1
                        })];
                    case 1:
